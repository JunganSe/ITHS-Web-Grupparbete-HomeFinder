        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewingDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    EstateAgentId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_AspNetUsers_EstateAgentId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_SaleStatuses_SaleStatusId",
                        column: x => x.SaleStatusId,
                        principalTable: "SaleStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Properties_Tenures_TenureId",
                        column: x => x.TenureId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpressionOfInterests", x => new { x.ApplicationUserId, x.PropertyId });
                    table.ForeignKey(
                        name: "FK_ExpressionOfInterests_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpressionOfInterests_Properties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpressionOfInterests_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_SaleStatusId",
                table: "Properties",
                column: "SaleStatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_TenureId",
                table: "Properties",
                column: "TenureId");
        }
