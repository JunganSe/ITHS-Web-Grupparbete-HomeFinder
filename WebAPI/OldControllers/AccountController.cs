...
namespace HomeFinder.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, RoleManager<IdentityRole> roleManager, IAccountRepository repo)
        {
        ...
        // POST: /Account/Create
        [HttpPost]
        public async Task<IActionResult> Create(PostAccountViewModel model)
        {
            try
            {
